<template>
    <div class="calendar-card">
        ...
        <div class="calendar-card__body" v-if="validatedRange.length === 0" key="no-range">
            <date-table
                    :date="date"
        ...
        <div v-else class="calendar-card__body" key="has-range">
            <date-table
...
<script>
    ...
    import DateTable from './calendar-table';
